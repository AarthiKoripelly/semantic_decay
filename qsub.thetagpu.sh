...
CUDA_VISIBLE_DEVICES=0 python run_nsp.py --pretrained_model_path /grand/projects/SuperBERT/mansisak/semantic_decay_models/checkpoints/2018/Computer-Science/ --start_year 2019 --end_year 2022 --subject Computer-Science >> nsp_cs_results.txt
